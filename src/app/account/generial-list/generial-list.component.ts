...
@Component({
  selector: 'app-generial-list',
  templateUrl: './generial-list.component.html',
  styleUrls: ['./generial-list.component.css']
})
export class GenerialListComponent implements OnInit {

  displayedColumns = ['position', 'name', 'weight', 'symbol', 'test', 'test1', 'test2', 'test3', 'test4', 'test5', 'test6', 'test7', 'test8', 'test10', 'test11', 'test12', 'test13', 'test14', 'test15', 'test16', 'test17', 'test18', 'test19', 'test20', 'test25'];
  ...
  openDialog() {
    ...
    // });
    this.router.navigate(['/account/general_entry']);
  }
